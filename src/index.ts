...
import { Players, ServerScriptService, StarterPlayer } from "@rbxts/services";
import { IS_SERVER } from "./constants/core";
import { Coro } from "./coro";
import { type Tree, findByTree } from "./utils/find-by-tree";

const processorParent = IS_SERVER ? ServerScriptService : Players.LocalPlayer.WaitForChild("PlayerScripts");
